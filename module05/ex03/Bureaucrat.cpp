...
/*   Updated: 2021/10/11 18:43:27 by rlinkov          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			Bureaucrat::signForm(Form &form){
	try{
		...
		std::cerr << *this << " cannot signs because " << e.what() << std::endl;
	}
}

void			Bureaucrat::executeForm(Form const &form){
	std::cout << *this << " try to executes " << form.getName() << std::endl;
	try{
		form.execute(*this);
	...
	{
		std::cerr << *this << " cannot executs " << form.getName() << " because " << e.what() << std::endl;
	}
}
